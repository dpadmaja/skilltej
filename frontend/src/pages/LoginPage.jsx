      ...
      <div className="flex flex-1 overflow-hidden mt-4">
        ...
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 items-center justify-center p-8">
          <svg className="w-full h-full max-w-lg max-h-lg" viewBox="0 0 400 500" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Watercolor blobs */}
            <circle cx="100" cy="100" r="55" fill="#3b82f6" opacity="0.3" filter="url(#watercolor-general)" />
            <circle cx="300" cy="120" r="75" fill="#6366f1" opacity="0.25" filter="url(#watercolor-general)" />
            <circle cx="80" cy="300" r="65" fill="#4f46e5" opacity="0.28" filter="url(#watercolor-general)" />
            <circle cx="320" cy="350" r="80" fill="#7c3aed" opacity="0.3" filter="url(#watercolor-general)" />
            <circle cx="200" cy="430" r="60" fill="#8b5cf6" opacity="0.25" filter="url(#watercolor-general)" />
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-6">
          <div className="w-full max-w-md">
            <div className="mb-8">
              ...
              <p className="text-gray-600 text-lg">Sign in to your Skilltej Certify account</p>
            </div>
